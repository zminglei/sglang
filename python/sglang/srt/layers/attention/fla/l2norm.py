...
# Fused extract + transpose from channel-first packed buffer.
# Reads (H*V, padded_T) and writes (1, T, H, V) contiguous.
# Same coalesced access pattern as l2norm_fwd_packed but without normalization.
@triton.jit
